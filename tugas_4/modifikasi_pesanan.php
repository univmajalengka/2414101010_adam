...
// 1. CEK KEAMANAN TINGKAT TINGGI
// Harus Login DAN Harus Role-nya Admin
if(!isset($_SESSION['status']) || $_SESSION['status'] != "login" || $_SESSION['role'] != "admin"){
    // Jika bukan admin, tendang paksa ke login
...
<head>
    ...
    <title>Kelola Pesanan - YOTS TRAVEL</title>
            ...
            <table class="custom-table">
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_array($query)){
                        // Logic menampilkan layanan (membuat array lalu digabung koma)
                        $layanan = [];
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <small style="opacity: 0.7;"><?php echo $row['no_hp']; ?></small>
                        </td>
                        <td>
                        ...
                        <td>
                            <?php 
                                ...
                                if(empty($layanan)) echo "<small style='opacity:0.5;'>Tidak ada</small>";
                            ?>
                        </td>
                        ...
                        <td style="text-align:center;">
                            <div style="display:flex; gap:8px; justify-content:center;">
                                <a href="form-edit.php?id=<?php echo $row['id']; ?>" class="btn-action btn-edit" title="Edit"><i class="ri-pencil-line"></i></a>
                                <a href="hapus-pesanan.php?id=<?php echo $row['id']; ?>" class="btn-action btn-delete" onclick="return confirm('Yakin ingin menghapus data atas nama <?php echo $row['nama_pemesan']; ?>?');" title="Hapus"><i class="ri-delete-bin-line"></i></a>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
